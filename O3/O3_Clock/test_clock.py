...
import unittest
from clock import Clock  # Koden som testes
...
class TestClock(unittest.TestCase):
    ...
    def test_inc_day_rollover(self):
        ...
        c = Clock(2021, 1, 1, 23, 59, 59)
        c.inc_sec()
        self.assertEqual(str(c), "2021-01-02 00:00:00")

    def test_inc_month_rollover(self):
        """Sjekker rulling ved månedsslutt (31. jan → 1. feb)."""
        c = Clock(2021, 1, 31, 23, 59, 59)
        c.inc_sec()
        self.assertEqual(str(c), "2021-02-01 00:00:00")

    def test_inc_year_rollover(self):
        """Sjekker rulling ved årsslutt (31. des → 1. jan)."""
        c = Clock(2023, 12, 31, 23, 59, 59)
        c.inc_sec()
        self.assertEqual(str(c), "2024-01-01 00:00:00")
    ...
    def test_property_set_invalid_day(self):
        ...
        c = Clock(2021, 2, 29)  # 2021 er ikke skuddår → dag=1
    ...
    def test_set_clock(self):
        ...
        c.set_clock(2021, 2, 29, 25, -1, 61)  # 2021: feb 29 → 1; time/min/sek klampes
        self.assertEqual(str(c), "2021-02-01 23:00:59")
